...
<jsp:useBean id="customPageTitle" scope="request"
	class="java.lang.String" /><bean:define id="pageTitle"
...
<jsp:useBean id="loginBean" scope="request"
	class="com.premiersolutionshi.old.bean.LoginBean" />

<jsp:useBean id="projectPk" scope="request" class="java.lang.String" />
<jsp:useBean id="inputBean" scope="request"
	class="com.premiersolutionshi.old.bean.HardwareBean" />
		...
		<div class="colright">
			<div class="col1wrap">
				<div class="col1">
					...
					<tags:projectPkBreadcrumb projectPk="${projectPk}"
						pageTitle="${pageTitle}" hideOptions="true"
						parentUrl="hardware.do?action=laptopList&projectPk=${projectPk}"
						parentTitle="Laptop List" />

					<p align="center">
						Fields marked with an asterisk <span class="regAsterisk">*</span>
						are required.
					</p>

					<p align="center">
					<center>
						<html:form action="hardware.do" onsubmit="return valFields();"
							method="POST">
							<input type="hidden" name="projectPk"
								value="<bean:write name="projectPk"/>" />
									...
									<tr>
										<td class="nobordered" align="left">
											...
											<table class="border-zero cellspacing-zero cellpadding-3"
												...
												<tr>
													<td rowspan="6" class="TOP"><img
														src="images/hardware/laptop.png" width="100" height="75" /></td>
													<td class="fieldName" nowrap><span class="regAsterisk">*</span>
														Product Name:</td>
													<td colspan="5"><html:select name="inputBean"
															property="currProductName"
															onchange="checkNew(this, 'productName');">
															<logic:present name="productNameList">
																<html:options name="productNameList" />
															</logic:present>
															<html:option value="null">Add new...</html:option>
														</html:select> <html:text name="inputBean" property="productName"
															size="20" maxlength="50" style="display:none;" /></td>
												</tr>

												<tr>
													<td class="fieldName TOP" nowrap>Status:</td>
													<td class="TOP"><html:select name="inputBean"
															property="status" styleId="status">
															<html:option value="" />
													...
													<td class="statusNotesTd TOP"><html:textarea
															name="inputBean" property="statusNotes"
															styleId="statusNotes" rows="3" cols="40" /></td>
												</tr>
